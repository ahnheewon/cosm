...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests((requests) -> requests
				.antMatchers("/","/top", "/login", "/joinForm", "/empCheckId", "/userInsert", "/userSelect", "/planUpdate", "/planInsert", "/insUpdate", "/insInsert", "/registInsert", "/minsert","/ajax/mdelinfo","/userCheckId","/clientInsert","/insPlay","/updateInsPlay","/getAlertList","/getAlert","/insertAlert","/updateAlert","/userInfo","/userConfirm","/equipment/*","/updateOrder","/registDelete")
				.permitAll().antMatchers("/produce/**").hasAnyAuthority("ROLE_D0101", "ROLE_D0105").antMatchers("/client/**","/orders/**").hasAnyAuthority("ROLE_D0102","ROLE_D0101", "ROLE_D0105").antMatchers("/equipment/**").hasAnyAuthority("ROLE_D0108","ROLE_D0107","ROLE_D0101", "ROLE_D0105").antMatchers("/**").hasAuthority("ROLE_D0101").anyRequest().authenticated()).formLogin()
