...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests((requests) -> requests
				.antMatchers("/","/top", "/login", "/joinForm", "/empCheckId", "/userInsert", "/userSelect","/userCheckId","/clientInsert","/getAlertList","/getAlert","/insertAlert","/updateAlert","/userInfo","/userConfirm","/logout")
