...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests((requests) -> requests
				...
				.permitAll().antMatchers("/client/**","/orders/**").hasAuthority("ROLE_D0102").antMatchers("/equipment/**").hasAnyAuthority("ROLE_D0108","ROLE_D0107").antMatchers("/**").hasAuthority("ROLE_D0101").anyRequest().authenticated()).formLogin()
