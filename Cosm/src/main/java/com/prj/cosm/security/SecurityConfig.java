...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests((requests) -> requests
				...
				.permitAll().antMatchers("/client/**","/material/**").hasAnyAuthority("ROLE_D0103","ROLE_D0104").antMatchers("/client/**","/orders/**").hasAnyAuthority("ROLE_D0102","ROLE_D0101").antMatchers("/equipment/**").hasAnyAuthority("ROLE_D0108","ROLE_D0107","ROLE_D0101","ROLE_D0106","ROLE_D0111").antMatchers("/**").hasAuthority("ROLE_D0101").anyRequest().authenticated()).formLogin()
